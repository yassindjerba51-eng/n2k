...
export const products: Product[] = [
  ...
  },
  {
    ...
    solution:
      "N2K BIOACTIVE est un nettoyant enzymatique concentré à base d'un complexe de protéases, lipases et amylases. Les enzymes dégradent les matières organiques en éléments solubles, facilitant leur élimination par rinçage ou action mécanique. Il prépare les surfaces à une désinfection optimale.",
    applications: [
