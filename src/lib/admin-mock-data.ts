...
export const mockBlogPosts: MockBlogPost[] = [
  ...
  },
  {
    ...
    tags: "eau, qualité, BIONET, OXYLIS HOCl",
    ...
    contentFr: "80% des pathologies en élevage avicole sont liées à la qualité de l'eau. Un programme de traitement en 2 étapes (BIONET + OXYLIS HOCl) garantit une eau conforme.",
    contentEn: "80% of pathologies in poultry farming are linked to water quality. A 2-step treatment program (BIONET + OXYLIS HOCl) guarantees compliant water.",
    contentAr: "80% من الأمراض في تربية الدواجن مرتبطة بجودة المياه. برنامج علاج من خطوتين (BIONET + OXYLIS HOCl) يضمن مياهًا مطابقة.",
  ...
  },
  {
    ...
    tags: "ambiance, ammoniac, OXYLIS HOCl",
    titleFr: "Ammoniac en élevage : comprendre et agir avec OXYLIS HOCl",
    titleEn: "Ammonia in farming: understanding and acting with OXYLIS HOCl",
    titleAr: "الأمونيا في التربية: الفهم والتصرف مع OXYLIS HOCl",
    contentFr: "L'ammoniac au-delà de 20 ppm provoque des lésions respiratoires et oculaires. OXYLIS HOCl réduit la charge ammoniacale de 70% en 48h par nébulisation.",
    contentEn: "Ammonia above 20 ppm causes respiratory and ocular lesions. OXYLIS HOCl reduces ammonia load by 70% in 48h through nebulization.",
    contentAr: "الأمونيا فوق 20 جزء في المليون تسبب آفات تنفسية وبصرية. OXYLIS HOCl يقلل حمولة الأمونيا بنسبة 70% خلال 48 ساعة من خلال الرذاذ.",
...
export const mockProtocols: MockProtocol[] = [
  ...
  },
  {
    ...
    productSlugs: ["bionet", "oxylis-hoci"],
    isActive: true,
  },
  {
    id: "proto_003",
    ...
    productSlugs: ["oxylis-hoci", "bioactive-n2k"],
    isActive: true,
  },
];
