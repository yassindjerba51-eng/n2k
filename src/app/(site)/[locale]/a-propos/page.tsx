            ...
            profiles={[
              {
                ...
                role: t("team.directorRole"),
                desc: t("team.directorDesc"),
                image: "/images/director.png"
              },
              {
                name: t("team.issamName"),
                role: t("team.issamRole"),
                desc: t("team.issamDesc"),
                image: ""
              },
              {
                name: t("team.mouradName"),
                role: t("team.mouradRole"),
                desc: t("team.mouradDesc"),
                image: ""
              }
            ]}
            staff={{
              title: t("team.staffTitle"),
              desc: t("team.staffDesc")
            }}
          />
        </div>
      </section>
