...
export default async function DiagnosticPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="bg-n2k-surface min-h-[calc(100vh-80px)] pb-32">
      {/* ====== HERO SECTION ====== */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-2/3 max-w">
              ...
              <nav className="flex items-center gap-3 text-white text-xs uppercase tracking-widest font-bold mt-10">
                ...
                <span className="text-n2k-secondary-light">{tNav("diagnostic")}</span>
              </nav>
            </div>
            {/* Right Column: Image */}
            <div className="w-full lg:w-1/3 relative mt-12 lg:mt-0">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 h-[300px] md:h-[450px] w-full bg-n2k-surface-high">
                <Image
                  src="/images/diagnostic-hero.png"
                  alt={t("pageTitle")}
                  fill
      ...
      {/* Form Container */}
      <section className="max-w-screen-2xl mx-auto px-4 md:px-8 relative z-20 mt-16 md:mt-24">
        <DiagnosticForm />
      </section>
    </div>
  );
