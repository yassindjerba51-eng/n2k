...
async function main() {
  ...
  const blogPosts = [
    // Featured Card 1 — "Problématique"
    {
      ...
      tags: "biofilm, problématique, qualité",
    ...
    // Featured Card 2 — "Erreur Critique"
    {
      ...
      tags: "résidus, erreur, conformité",
    ...
    // Featured Card 3 — "Solution N2K"
    {
      ...
      tags: "automatisation, solution, NEP",
    ...
    // Library Article 1 — Traçabilité
    {
      ...
      tags: "traçabilité, audit, digitalisation",
    ...
    // Library Article 2 — Purification de l'Air
    {
      ...
      tags: "air, purification, conditionnement",
    ...
    // Library Article 3 — Désinfection Durable
    {
      ...
      tags: "désinfection, écologie, durable",
