...
const coverImage = "/images/blog/poultry-air-quality.png";

async function main() {
  console.log("Updating article: Ammoniac persistant...");
  ...
  console.log("✅ Article rewritten and database updated!");
}
